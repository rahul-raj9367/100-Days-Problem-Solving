...
class MinimumNumberofDaystoMakemBouquets{
	static int findMinimumNumberofDaystoMakemBouquets(int arr[],int m,int k){
		if(arr.length<m*k){
			return -1;
		}
	...
	public static void main(String[] args) {
		...
		int m=2,k=3;
		System.out.println(findMinimumNumberofDaystoMakemBouquets(arr,m,k));
	}
}
/*
OUTPUT
